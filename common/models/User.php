...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function getMobile($params)
    {
        ...
        if (null === $model || !$model->validatePassword($password)) {
            return Json::encode(['code' => 1, 'msg' => '无效的用户或密码不正确!']);
        }
        return Json::encode(['code' => 0, 'mobile' => $model->mobile]);
    }
