 ...
 * ]
 * ]);
 * // WxGh::findOne(['gh_id' => WxGh::DEFAULT_GH_ID])->getWxApp();
 *
 * // 使用方法
...
class WX extends Component
{
	...
	public function getApplication() {
		if ($this->application === null) {
			//$this->application = new \EasyWeChat\EasyWeChat\Work\Application($this->config);
			$this->application = new \EasyWeChat\OfficialAccount\Application($this->config);
		}
