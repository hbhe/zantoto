...
use common\models\ProductOptionValueSearch;
use Yii;
...
class ProductOptionValueController extends Controller
{
    ...
    /**
     * Lists all ProductOptionValue models.
     * @return mixed
     */
    public function actionIndex()
    {
        Yii::$app->user->setReturnUrl(Url::current());
        $searchModel = new ProductOptionValueSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        if (Yii::$app->request->isPost) {
            $ids = Yii::$app->request->post('selection');
            if (Yii::$app->request->post('begin')) {
                $models = ProductOptionValue::findAll($ids);
    ...
    /**
     * Displays a single ProductOptionValue model.
     * @param integer $id
     * @return mixed
     */
