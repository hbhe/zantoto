...
<?php /*
                ...
                <li class="hide dropdown messages-menu">
                ...
                <li class="hide dropdown notifications-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <li class="hide dropdown tasks-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
...
*/ ?>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo Yii::$app->user->identity->userProfile->getAvatar("{$directoryAsset}/img/user2-160x160.jpg") ?>"
                             class="user-image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header light-blue">
                            ...
                            <p>
                                ...
                                <small>
                                    <?= implode(' | ', Yii::$app->user->identity->getRoleNames()); ?>
                                </small>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-left">
                                <?php echo Html::a(Yii::t('backend', 'Profile'), ['/user/profile'], ['class' => 'btn btn-default btn-flat']) ?>
                            </div>
                            <div class="pull-left">
