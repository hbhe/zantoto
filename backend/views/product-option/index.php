...
/* @var $searchModel common\models\ProductOptionSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = '商品规格: ' . $model->title;
...
<div class="product-option-index">
 ...
 ?>
    ...
    <p>
        ...
        <?php if (YII_ENV_DEV): ?>
            <?php echo Html::a('初始化商品规格', ['init', 'product_id' => $model->id], [
                    'class' => 'btn btn-danger',
                    'data' => [
                        'confirm' => ' 导入所属分类中的商品规格?',
                        'method' => 'post',
                     ],
//                    'data-confirm' => '确认初始化商品规格?',
//                    'data-method' => 'post',
            ]) ?>
        <?php endif; ?>
    </p>
